...
export const Terminos = () => {
    return (
        <>
            ...
            <h2>Tus datos de identificación. Los usuarios tienen que saber a quién es el propietario de la página web. Y también a quién están pagando a la hora de contratar cualquier producto o servicio.
