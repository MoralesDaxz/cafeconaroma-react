  ...
  return (
    <>
      <div className='bg-[#FFFFFF] w-full min-h-[100vh] flex flex-col items-center px-10 pb-10 pt-[7rem]'>{/* 535px */}
        ...
        <form className='flex flex-col w-full ' onSubmit={handleSubmit((data) => {
          ...
          <div className='flex flex-row justify-center gap-6'>
            ...
            <div className='w-[60%]  flex flex-col gap-6'>
              ...
              {inputKind === 'tarjeta' ? <div className='w-[279px]  h-[150px] transition-all ease  duration-[500ms] flex flex-col '>
                <div className={'gap-2'}>
              ...
              <div className={inputKind === 'tarjeta' ? 'w-[98%] h-[1px] bg-[#E3DED7] self-center mt-[24px]' : 'w-[98%] h-[1px] bg-[#E3DED7] self-center mt-[-20px]'}></div>
              ...
              <div className=''>
                <div className='bg-[#F7F5F3] w-[30%] p-6 fixed z-60 '>
                  ...
                  <div className='flex flex-row gap-7 mt-4'>
                    <Link to={'/Success'}><input onClick={() => { orderInLS() }} type='submit' value={'Pagar y realizar pedido'} className={'bg-[#2A5B45] opacity-30 cursor-pointer hover:opacity-100 w-[196px] h-[40px] flex flex-col justify-center items-center rounded text-[white] font-semibold text-sm'} text={'Pagar y realizar pedido'} /> </Link>
                  </div>
                </div>
              </div>
            </div>
